# Generated by Django 4.2.15 on 2025-08-28 09:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "username",
                    models.CharField(max_length=12, unique=True, verbose_name="Username"),
                ),
                (
                    "security_question",
                    models.CharField(
                ...
                (
                    "email",
                    models.EmailField(db_index=True, max_length=254, unique=True, verbose_name="Email"),
                ),
                (
                    "first_name",
                ...
                (
                    "middle_name",
                    models.CharField(blank=True, max_length=30, null=True, verbose_name="Middle Name"),
                ),
                (
                    "last_name",
                ...
                (
                    "id_no",
                    models.PositiveBigIntegerField(unique=True, verbose_name="ID Number"),
                ),
                (
                    "account_status",
                    models.CharField(
                ...
                (
                    "otp_expiry_time",
                    models.DateTimeField(blank=True, null=True, verbose_name="OTP Expiry Time"),
                ),
                (
                    "groups",
